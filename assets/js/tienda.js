...
if(filter_color.length>0){      
      for(const fc of filter_color){
            fc.addEventListener("click", (e) => {
                  e.preventDefault()                  
                  const resultado = productos.filter((producto) => (producto.color == e.currentTarget.id && producto.stock>0))
...
if(filter_talla.length>0){      
      for(const ft of filter_talla){
            ft.addEventListener("click", (e) => {
                  e.preventDefault()                  
                  const resultado = productos.filter((producto) => (producto.talla == e.currentTarget.id && producto.stock>0))
                  productosTiendaX.innerHTML=""
                  cargarTienda(resultado)                                   
            })
      }
