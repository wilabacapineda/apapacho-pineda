      ...
      if(productoModelo){
            ...
            function cargarProducto(){
                  ...
                  productoModelo.forEach( (producto) => {
                        if(i==0){
                              ...
                              const producto_div_rangoPrecios=document.createElement("div")
                                    ...
                                    producto_div_rangoPrecios.innerHTML="<h5>$"+min.toLocaleString()+" - $"+max.toLocaleString()+"</h5>"
                              //Select Talla
                  ...
                  if(options_color.length==2){
                        ...
                        document.getElementById("productoSelectColor").value=options_color[1].value                    
                  }
                  const options_talla = document.getElementById("productoSelectTalla").querySelectorAll("option")
                  if(options_talla.length==2){
                        options_talla[1].selected=true
                        document.getElementById("productoSelectTalla").value=options_talla[1].value                        
                  }                   
            }
            cargarProducto()
                        ...
                        productoModeloF.forEach((prod) => {
                              ...
                              if(prod.stock>0){
                                    ...
                                    const producto_div_variations_price=document.createElement("span")
                                          producto_div_variations_price.innerHTML = "$"+prod.precio.toLocaleString()
